...
#ANALISIS 1 (Analisa jumlah Nasabah Yang Memiliki Credit Score rendah berdasarkan gender)
SELECT
    CASE 
...
#ANALISIS 4 (Pengaruh Antara Pendapatan per kapita dan Hutang Terhadap Credit Score)
SELECT 
    id AS client_id,
